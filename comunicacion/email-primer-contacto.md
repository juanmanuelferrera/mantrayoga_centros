...
Reglas: corto, sin adjuntar el dossier en el primer envío si el email es en
frío (los adjuntos de desconocidos no se abren), asunto sin mayúsculas ni signos
de exclamación, y una sola petición al final.

Se envía a la dirección de contacto del centro, y si tienes el nombre del dueño
o profesor, mejor por Instagram (ver `whatsapp.md`).
...
convence, no hay segundo.

¿Te paso una hoja con el detalle, o prefieres que hablemos cinco minutos por
teléfono?
...
## Versión B: tenéis contacto previo o alguien os presenta
...
## Seguimiento (a los 7 días, si no contestan)
...
No hay. Dos emails y se cierra la ficha con estado "sin respuesta". Se puede
reabrir en seis meses.

---

## Lo que no se pone nunca

- "Espero que este mensaje te encuentre bien."
- Párrafos largos explicando qué es el bhakti yoga.
- Más de una pregunta al final.
- Emojis.
- Adjuntos de más de 1 MB.
