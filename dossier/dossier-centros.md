# Dossier para centros de yoga

Fuente del PDF de dos páginas que se envía adjunto al primer email. Se lee en
noventa segundos o no se lee.

Regla: la primera frase habla de lo que gana el centro, no de lo que ofrecemos
nosotros.

---

# MANTRA YOGA
## Un taller de una hora para tus alumnos, sin coste para el centro
...
- **Llena una franja floja del horario** sin pagar a nadie.
- **Algo distinto para tus alumnos** sin que tengas que montarlo tú.
- **No compite con tus clases.** Nadie deja el vinyasa por esto. Es
  complementario y se nota en la clase de asana de la semana siguiente.
- **Gente nueva conoce tu centro.** Los que vengan de fuera son alumnos
  potenciales tuyos, no nuestros.
- **Contenido listo para tus redes:** cartel y textos ya hechos.
...
los *Yoga-sutras* 1.27 y 1.28: el sonido y su repetición como práctica.
